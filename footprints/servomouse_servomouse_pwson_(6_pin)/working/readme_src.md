...
| number of pads | 7 | 
| github path | http://github.com/servomouse/servomouse.pretty/blob/master/PWSON (6-pin).kicad_mod | 
| oomp key | oomp_servomouse_servomouse_pwson_(6_pin) | 
| oomp bot github | https://github.com/oomlout/oomlout_oomp_footprint_bot/tree/main/footprints/servomouse_servomouse_pwson_(6_pin)/working | 
## Images  
