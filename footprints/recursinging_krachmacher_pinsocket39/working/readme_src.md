...
oomp key: oomp_recursinging_krachmacher_pinsocket39  
...
| name | value | 
| --- | --- | 
| footprint name | PinSocket39 | 
| footprint description | Through hole straight socket strip, 1x39, 2.54mm pitch, single row | 
| number of pads | 39 | 
| github path | http://github.com/recursinging/kxmx/blob/master/kxmx_erack/kicad/kicad/libraries/krachmacher.pretty/PinSocket39.kicad_mod | 
| oomp key | oomp_recursinging_krachmacher_pinsocket39 | 
| oomp bot github | https://github.com/oomlout/oomlout_oomp_footprint_bot/tree/main/footprints/recursinging_krachmacher_pinsocket39/working | 
## Images  
