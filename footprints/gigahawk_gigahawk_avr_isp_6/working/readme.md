...
oomp key: oomp_gigahawk_gigahawk_avr_isp_6  
...
| name | value | 
| --- | --- | 
| footprint name | AVR-ISP-6 | 
| footprint description | Through hole straight pin header, 2x03, 2.54mm pitch, double rows | 
| number of pads | 6 | 
| github path | http://github.com/Gigahawk/Gigahawk.pretty/blob/master/AVR-ISP-6.kicad_mod | 
| oomp key | oomp_gigahawk_gigahawk_avr_isp_6 | 
| oomp bot github | https://github.com/oomlout/oomlout_oomp_footprint_bot/tree/main/footprints/gigahawk_gigahawk_avr_isp_6/working | 
## Images  
