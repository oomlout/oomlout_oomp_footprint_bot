...
| name | value | 
| --- | --- | 
| footprint name | BUS_PCI_Express_Mini | 
| footprint description | Mini-PCI Express bus connector (https://s3.amazonaws.com/fit-iot/download/facet-cards/documents/PCI_Express_miniCard_Electromechanical_specs_rev1.2.pdf#page=11) | 
| number of pads | 56 | 
